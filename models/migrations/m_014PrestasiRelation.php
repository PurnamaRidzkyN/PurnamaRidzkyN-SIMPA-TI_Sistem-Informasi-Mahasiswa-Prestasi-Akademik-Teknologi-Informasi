...
class m_014PrestasiRelations implements BaseMigration
{
    public function up(): array
    {
        return [
            Schema::alterTable("prestasi", function (Blueprint $table) {
                ...
                $table->alterAddForeignKey("id_jenis_kompetisi", "jenis_lomba", "id", "Fk_id_jenis_kompetisi_prestasi");

                // Relasi ke tingkat_lomba
                $table->alterAddForeignKey("id_tingkat_kompetisi", "tingkat_lomba", "id", "Fk_id_tingkat_kompetisi_prestasi");
