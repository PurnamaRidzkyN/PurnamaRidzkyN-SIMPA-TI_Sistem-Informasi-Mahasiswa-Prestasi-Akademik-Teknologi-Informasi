<div class="navbar">
    <div class="logo">
        <img src="../../../../public/component/logoBiru.png" alt="Logo" width="50">
        <h1>SIMPA-TI</h1>
    </div>
    <div class="menu">
        <a href="#home">Home</a>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addAdminModalLabel">Tambah Data Mahasiswa</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="<?php echo '/dashboard/admin/' . Session::get("user") . '/mahasiswa-data/insert' ?> " method="POST" enctype="multipart/form-data" id="batchForm">
                        <div id="adminInputs">
                            <div class="admin-group border p-3 mb-3">
                                <h6>Admin 1</h6>
                                <div class="mb-3">
                                    <label for="name1" class="form-label">Nama mahasiswa</label>
                                ...
                                <div class="mb-3">
                                    <label for="nip1" class="form-label">NIM</label>
